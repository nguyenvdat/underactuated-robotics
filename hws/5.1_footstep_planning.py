# -*- coding: utf-8 -*-
"""Copy of footstep_planning.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1JvUVDDBV-rrrhVRkEc7akd6WQPqH4V4z
...
def minimize_step_length(prog, n_steps, decision_variables):
    ...
    # modify here
    for t in range(n_steps):
      prog.AddQuadraticCost(np.dot(position_left[t+1] - position_left[t], position_left[t+1] - position_left[t]))
      prog.AddQuadraticCost(np.dot(position_right[t+1] - position_right[t], position_right[t+1] - position_right[t]))
